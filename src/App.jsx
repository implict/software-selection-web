                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {items.map(sw => (
                      ...
                      >
                        {/* Custom Tooltip */}
                        <div
                          className="custom-tooltip absolute left-0 top-0 px-2 py-1 bg-gray-50 border border-gray-300 text-gray-600 text-[11px] rounded-none shadow-sm opacity-0 group-hover:opacity-100 transition-opacity duration-75 delay-0 group-hover:delay-500 z-50 pointer-events-none whitespace-nowrap"
